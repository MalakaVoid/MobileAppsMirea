package ru.mirea.azbukindu.firebaseauth;
...
import ru.mirea.azbukindu.firebaseauth.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity{
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            binding.authTable.setVisibility(View.VISIBLE);
